...
<head>
    ...
    <title>Administration Image Category</title>
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center" style="margin: 50px 0px 10px 0px;">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <p>Search 'id_categoryImage' or 'id_categorycategorynews' or 'name_categoryImage'</p>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <table class="table table-dark table-hover table-bordered" style="text-align: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="ad_category_news_update.php?id_categoryImage=<?php echo $row['id_categoryImage']; ?>">Sửa</a>
                                </td>
                                <td>
                                    <a onclick="return remove(<?php echo $row['id_categoryImage']; ?>)" href="ad_category_news_remove.php?id_categoryImage=<?php echo $row['id_categoryImage']; ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                                    }
    ...
    <div class="row" style="margin: 5% 0px">>
        <div class="col-lg-12">
            <img style="width: 100%; height: 200px;" src="https://categorynews.freepik.com/free-vector/digital-neon-game-banner_1017-19897.jpg" alt="end game">
        </div>
    </div>
