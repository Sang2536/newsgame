<?php 
    ...
    if(isset($_POST['searchUser']) && $_POST['searchUser'] != ''){
        $sql = 'SELECT * FROM user WHERE id_user like "%' . $_POST['searchUser'] .'%" or email_user like "%' . $_POST['searchUser'] .'%" or or Position_user like "%' . $_POST['searchUser'] .'%" isBlock_user like "%'. $_POST['searchUser'] .'%" ';
    }
    // 
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center" style="margin: 50px 0px 10px 0px;">
            <div class="col-lg-6">
                <a href="/newsgame/php/administration/ad_user_add.php" class="btn btn-primary stretched-link">Add User</a>       
            </div>
                    ...
                    <div class="col-lg-12">
                        <form class="form-inline" method="POST">
                            <div class="form-group mx-sm-3 mb-2">
                                ...
                                <input type="tect" name="searchUser" class="form-control" id="inputPassword2" placeholder="Key word">
                            </div>
                    ...
                    <table class="table table-dark table-hover table-bordered" style="text-align: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="ad_user_update.php?id_user=<?php echo $row['id_user']; ?>">Sửa</a>
                                </td>
                                <td>
                                    <a onclick="return remove(<?php echo $row['id_user']; ?>)" href="ad_user_remove.php?id_user=<?php echo $row['id_user']; ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                                    }
