...
<head>
    ...
    <title>Administration Games</title>
...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center" style="margin: 50px 0px 10px 0px;">
            <div class="col-lg-6">
                <a href="/newsgame/php/administration/ad_games_add.php" class="btn btn-primary stretched-link">Add Games</a>       
            </div>

            <!-- search id and id_category -->
            <div class="col-lg-6">
                <div class="row">
                    <p>Search 'id_games' or 'name_games' or 'graphics_games' or 'category_games'</p>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-inline" method="POST">
                            <div class="form-group mx-sm-3 mb-2">
                                ...
                                <input type="tect" name="searchGames" class="form-control" id="inputPassword2" placeholder="Key word">
                            </div>
                    ...
                    <table class="table table-dark table-hover table-bordered" style="text-align: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="ad_games_update.php?id_game=<?php echo $row['id_game']; ?>">Sửa</a>
                                </td>
                                <td>
                                    <a onclick="return remove(<?php echo $row['id_game']; ?>)" href="ad_games_remove.php?id_game=<?php echo $row['id_game']; ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                                    }
