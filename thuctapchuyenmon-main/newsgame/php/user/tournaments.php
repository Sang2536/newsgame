...
<div class="container">
        <div class="row justify-content" style="width: 100%; height: auto; margin-bottom: 200px;" style="background-color: lightseagreen;">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 news_big" style="padding-right: 0px 10px; margin-bottom: 30px;">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <p style="float: right">
                            <i>
                                <?php echo $rowNews['dateCreate_post']; ?>
                            </i>
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <a class="news_post nav-link" href="news_detail.php?id_news=<?php echo $row['id_news']; ?>">
                            ...
                            <img src="<?php echo $row['urlImage_news']; ?>" style="width: 100%; height: 120px;"  alt="img" >
        ...
        <div class="row" style="margin-top: 50px;">
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 "> 
                ...
                <div class="row list-3" style="background-color: lightseagreen; margin-bottom: 20px;">
        ...
        <div class="row" style="margin-top: 50px;">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 " style="background-color: darkcyan;">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12" style="height: 400px; text-align: justify; color: black; border: 2px solid red; border-radius: 5px">
                        ...
                        <div class="row" style="height: 150px;">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <a href="news_detail.php?id_news=<?php echo $row['id_news']; ?>">
                                    <br>
                                        <p style="color: black;"><?php echo $row['title_news']; ?></p>
                                    </br>
                                </a>
                            </div>
                        </div>
