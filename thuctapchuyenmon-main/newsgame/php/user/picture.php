    ...
    <div class="container">
        <div class="row" style="margin: 100px 0px 70px 0px;">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                       <img src="<?php echo $row['urlImage_categoryImage'] ?>" style="width: 100%; height: 350px;" alt="load img false">
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <a href="">
                            <p style="font-size: 25px; text-align:center; height: 100px;"> <?php echo $row['name_categoryImage']; ?> </p>
                        </a>
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <p>
